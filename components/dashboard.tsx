...
export default function Dashboard({ user }: { user: User }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setIsLoading(false)
      showToast(t["welcome-back"], `${t["hello"]}, ${user.username}! ${t["welcome-dashboard"]}`, "success")
    }, 1000)
      ...
      <div className={`main-content ${!sidebarVisible ? "full" : ""}`}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {activeSection === "osis" && <OsisSection language={language} setImagePopupSrc={setImagePopupSrc} />}
            {activeSection === "images" && <ImagesSection language={language} setImagePopupSrc={setImagePopupSrc} />}
